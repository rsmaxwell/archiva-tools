...
func (c *ArchivaClient) DeleteManagedRepository(session *Session, id string, deleteContent bool) (bool, error) {

	baseUrl := c.baseUrl()
	url := baseUrl + "/" + deleteManagedRepositoryEndpoint
	...
	q := req.URL.Query()
	q.Add("repositoryId", id)
	q.Add("deleteContent", "true")
